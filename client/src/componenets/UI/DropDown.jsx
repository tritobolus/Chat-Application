...
export const DropDown = () => {
    const { users, username, onlineUsers, setCurrentUser, currentUser, handleDropdown, dropDown, newGroup, handleNewGroup } = useCC();
  ...
  return (
    <>
      <div className=" relative flex flex-col gap-y-2 w-35 bg-white p-2 rounded-lg text-sm">
        ...
        <div className="flex gap-x-2 items-center justify-start hover:cursor-pointer p-1 rounded text-red-500 border-t-2 border-gray-200 pt-2">
          <IoIosLogOut size={16} />
          <p>Log out</p>
        </div>
